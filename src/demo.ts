...
let nodeTemplateFemale = `
	<g>
      ...
      <text transform="translate(84.67 65.9)" font-size="10" fill="#939598" font-family="Roboto">##info##</text>
      <g clip-path="url(#a)">
      ...
      <path d="M205,73.92A5.07,5.07,0,0,1,200,79H20a5.07,5.07,0,0,1-5-5.08V20.08A5.07,5.07,0,0,1,20,15H200a5.07,5.07,0,0,1,5,5.08V73.92Z"  class="orgchart-box" fill="transparent"/>
    </g>`;
...
config.onBoxRender = (args: RenderBoxEventArgs) => {
	...
	tpl = tpl.replace('##info##', '[ ' + args.index + ', ' + args.level + ' ]');
