import {OrgChartSvg} from '../../src/orgchart.svg';


describe('OrgChart.svg module', () => {
	...
	//});
	//
	it('should have a working unit test', () => {
		expect(true).toBe(true);
	});

	it('should have a working unit test 2', () => {
		expect(true).toBe(true);
	});

	it('should have a working unit test 3', () => {
		expect(true).toBe(true);
	});
});
