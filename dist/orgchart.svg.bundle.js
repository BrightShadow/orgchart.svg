...
(function() {
var define = $__System.amdDefine;
define("9", ["require", "exports", "8"], function(require, exports, node_options_1) {
  "use strict";
...
(function() {
var define = $__System.amdDefine;
define("1", ["require", "exports", "7", "9", "a", "c", "e"], function(require, exports, es6_promise_1, org_chart_config_1, connector_type_1) {
  "use strict";
  var OrgChartSvg = (function() {
    ...
    OrgChartSvg.prototype.adjustSiblingNodesByDelta = function(levelNode, isCollapsed, moveDelta, siblings) {
      ...
      for (var i = 0; i < neighbors.left.length; i++) {
        ...
        promises.push(new es6_promise_1.Promise(function(resolve) {
          node.animate({transform: node.transform().localMatrix.translate(moveDelta, 0)}, animDuration, mina.easein, function() {
            resolve();
          });
        }));
        ...
        if (childNodesGroup !== null) {
          promises.push(new es6_promise_1.Promise(function(resolve) {
            childNodesGroup.animate({transform: childNodesGroup.transform().localMatrix.translate(moveDelta, 0)}, animDuration, mina.easein, function() {
              resolve();
            });
          }));
        }
        ...
        if (childLinesGroup && childLinesGroup !== null) {
          promises.push(new es6_promise_1.Promise(function(resolve) {
            childLinesGroup.animate({transform: childLinesGroup.transform().localMatrix.translate(moveDelta, 0)}, animDuration, mina.easein, function() {
              resolve();
            });
          }));
        }
        ...
        if (topLines && topLines !== null) {
          for (var c = 0; c < topLines.length; c++) {
            promises.push(new es6_promise_1.Promise(function(resolve) {
              topLines[c].animate({transform: topLines[c].transform().localMatrix.translate(moveDelta, 0)}, animDuration, mina.easein, function() {
                resolve();
              });
            }));
          }
      ...
      for (var i = 0; i < neighbors.right.length; i++) {
        ...
        promises.push(new es6_promise_1.Promise(function(resolve) {
          node.animate({transform: matrix}, animDuration, mina.easein, function() {
            resolve();
          });
        }));
        var childNodesGroup = this.findNodesGroupByParentId(id);
        if (childNodesGroup !== null) {
          ...
          promises.push(new es6_promise_1.Promise(function(resolve) {
            childNodesGroup.animate({transform: matrix}, animDuration, mina.easein, function() {
              resolve();
            });
          }));
        }
